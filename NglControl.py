...
class PowerUpTimer(object):
    def __init__(self, *args, **kwargs):
        ...
        self.kwargs = kwargs
        self.timer = None
        #self.powerupcomplete = False

    # def PowerUpInProgress(self):
    #     return self.powerupcomplete

    def PowerUpComplete(self):
        global recycletimer
        global powerupinprogress
        reportmsg('Power up complete', 2)
        powerupinprogress = False
        recycletimer.start()
